...
class ProgramInit():
    ...
    CHANNEL = "正式版"  # 程序更新通道
    REQUEST_HEADER = {"User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/122.0.0.0 Safari/537.36 Edg/122.0.0.0"}  # 程序默认网络请求头
    REQUIRE_LIB = ["PyQt6-Fluent-Widgets[full]",
                   "qt6-tools",
                   "requests",
                   "bs4",
                   "lxml",
