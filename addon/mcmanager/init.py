...
class BigModInfoCard(BigInfoCard):
    ...
    def __init__(self, data: dict, parent: QWidget = None, widgets=[]):
        ...
        self.thread1 = MyThread("获得模组信息", [data["id"], data["来源"]])
    ...
    def thread1_1(self, msg):
        ...
        self.comboBox1.setToolTip("选择模组版本")
    ...
    def getFileInfo(self):
        ...
        self.thread2 = MyThread("获得模组文件", [self.data["id"], self.data["来源"], self.comboBox1.currentText(), self.comboBox2.currentText()])
...
class SmallFileInfoCard(SmallInfoCard):
    ...
    def mainButtonClicked(self):
        ...
        self.thread1 = MyThread("下载模组", (self.data["文件名称"], self.data["下载链接"]))
