...
x1 = 0
y1 = 0
Label(tk, text="一次函数").place(x=x1 + 75, y=y1, width=150, height=30)
Label(tk, text="y=").place(x=x1 + 50, y=y1 + 30, width=40, height=20)
entry7 = Entry(tk)
entry7.place(x=x1 + 70, y=y1 + 30, width=30, height=20)
Label(tk, text="x+").place(x=x1 + 100, y=y1 + 30, width=40, height=20)
entry8 = Entry(tk)
entry8.place(x=x1 + 120, y=y1 + 30, width=30, height=20)
Button(tk, text="计算", style="TButton", command=b5).place(x=x1, y=y1 + 55, width=100, height=30)
Button(tk, text="绘制", style="TButton", command=b6).place(x=x1 + 100, y=y1 + 55, width=100, height=30)
x1 = 200
y1 = 0
Label(tk, text="反比例函数").place(x=x1 + 70, y=y1, width=150, height=30)
Label(tk, text="y=").place(x=x1 + 70, y=y1 + 30, width=40, height=20)
entry9 = Entry(tk)
entry9.place(x=x1 + 90, y=y1 + 30, width=30, height=20)
Label(tk, text="/x").place(x=x1 + 120, y=y1 + 30, width=40, height=20)
Button(tk, text="绘制", style="TButton", command=b7).place(x=x1 + 50, y=y1 + 55, width=100, height=30)
x1 = 0
y1 = 95
Label(tk, text="一般式").place(x=x1 + 75, y=y1, width=150, height=30)
Label(tk, text="y=").place(x=x1, y=y1 + 30, width=40, height=20)
entry1 = Entry(tk)
entry1.place(x=x1 + 20, y=y1 + 30, width=30, height=20)
Label(tk, text="x²+").place(x=x1 + 50, y=y1 + 30, width=40, height=20)
entry2 = Entry(tk)
entry2.place(x=x1 + 75, y=y1 + 30, width=30, height=20)
Label(tk, text="x+").place(x=x1 + 105, y=y1 + 30, width=40, height=20)
entry3 = Entry(tk)
entry3.place(x=x1 + 125, y=y1 + 30, width=30, height=20)
Button(tk, text="计算", style="TButton", command=b1).place(x=x1, y=y1 + 55, width=100, height=30)
Button(tk, text="绘制", style="TButton", command=b2).place(x=x1 + 100, y=y1 + 55, width=100, height=30)
x1 = 200
y1 = 95
Label(tk, text="顶点式").place(x=x1 + 75, y=y1, width=150, height=30)
Label(tk, text="y=").place(x=x1, y=y1 + 30, width=40, height=20)
entry4 = Entry(tk)
...
Label(tk, text=")²+").place(x=x1 + 105, y=y1 + 30, width=40, height=20)
entry6 = Entry(tk)
entry6.place(x=x1 + 125, y=y1 + 30, width=30, height=20)
Button(tk, text="计算", style="TButton", command=b3).place(x=x1, y=y1 + 55, width=100, height=30)
Button(tk, text="绘制", style="TButton", command=b4).place(x=x1 + 100, y=y1 + 55, width=100, height=30)
Label(tk, text="二次函数").place(x=170, y=85, width=100, height=30)
x1 = 0
y1 = 185
Label(tk, text="自由绘制").place(x=x1 + 170, y=y1, width=150, height=30)
Label(tk, text="y=").place(x=x1, y=y1 + 30, width=20, height=20)
entry11 = Entry(tk)
entry11.place(x=x1 + 20, y=y1 + 30, width=30, height=20)
Label(tk, text="x⁵+").place(x=x1 + 50, y=y1 + 30, width=25, height=20)
entry12 = Entry(tk)
entry12.place(x=x1 + 75, y=y1 + 30, width=30, height=20)
Label(tk, text="x⁴+").place(x=x1 + 105, y=y1 + 30, width=25, height=20)
entry13 = Entry(tk)
entry13.place(x=x1 + 130, y=y1 + 30, width=30, height=20)
Label(tk, text="x³+").place(x=x1 + 160, y=y1 + 30, width=25, height=20)
entry14 = Entry(tk)
entry14.place(x=x1 + 185, y=y1 + 30, width=30, height=20)
Label(tk, text="x²+").place(x=x1 + 215, y=y1 + 30, width=25, height=20)
entry15 = Entry(tk)
entry15.place(x=x1 + 240, y=y1 + 30, width=30, height=20)
Label(tk, text="x+").place(x=x1 + 270, y=y1 + 30, width=20, height=20)
entry16 = Entry(tk)
entry16.place(x=x1 + 290, y=y1 + 30, width=30, height=20)
Button(tk, text="绘制", style="TButton", command=b8).place(x=150, y=240, width=100, height=30)
