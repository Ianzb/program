...
Button(tk, text="计算", command=b5).place(x=x1, y=y1 + 55, width=100, height=30)
Button(tk, text="绘制", command=b6).place(x=x1 + 100, y=y1 + 55, width=100, height=30)
x1 = 200
y1 = 0
...
Button(tk, text="绘制", command=b7).place(x=x1 + 50, y=y1 + 55, width=100, height=30)
x1 = 0
y1 = 95
...
Button(tk, text="计算", command=b1).place(x=x1, y=y1 + 55, width=100, height=30)
Button(tk, text="绘制", command=b2).place(x=x1 + 100, y=y1 + 55, width=100, height=30)
x1 = 200
y1 = 95
...
Button(tk, text="计算", command=b3).place(x=x1, y=y1 + 55, width=100, height=30)
Button(tk, text="绘制", command=b4).place(x=x1 + 100, y=y1 + 55, width=100, height=30)
...
Button(tk, text="绘制", command=b8).place(x=150, y=240, width=100, height=30)
