...
ttk.Label(tk, text="zb的小程序For " + edition + " 版本  " + version).place(x=30, y=160, width=200, height=30)
ttk.Button(tk, text="设置", style="TButton", command=lambda: MyThread(b4)).place(x=230, y=160, width=80, height=30)
ttk.Button(tk, text="检查更新", style="TButton", command=lambda: MyThread(b3)).place(x=310, y=160, width=80, height=30)
